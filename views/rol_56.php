...
<div id="tabs" class="tabs">
				...
				<nav>
                    ...
                    <li><a href="#section-1" class="icon-task"><span>
...
$(document).on('click','#btn_guardar_numero_soporte', function(e){
        ...
        if($('#btn_guardar_numero_soporte').val()==""){
            ...
            let pago_realizado = ($("#pagorealizado").val()).replaceAll(".", "").replaceAll(",", "");

            campos+="&pagorealizado="+pago_realizado;
            console.log(pago_realizado);

            campos+="&observaciones_pago="+$("#observaciones_pago").val();
                  ...
                  <iframe id="iframe_soporte" src="" name="soporte" style="height:600px;width:100%;" title="Soporte"></iframe>
                    ...
                    <form id='form_numero_validar'>
                        ...
                        <p>
                            ...
                            <input id='observaciones_pago' type="text" name='observaciones_pago'/>
                        ...
                        <p>
                            ...
                            <input type="text" onkeyup="format(this)" onchange="format(this)" name="pagorealizado" id="pagorealizado"/>
