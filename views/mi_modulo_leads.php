...
<script>
	...
	var nombre_ciudad=consultar_campo("tbl_ciudades","nombre","codigo_ciudad="+codigo_ciudad);
    ...
    var identidad = {
		...
		consulta_filtro:' where tc.proceso_leads=1 AND lc.disponible IN (0,1) AND tc.expedida="'+nombre_ciudad+'" AND lc.id_empleado IS NULL OR  lc.id_empleado='+ codigo_usuario + ' ORDER BY lc.id_empleado',
