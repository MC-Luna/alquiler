    	...
    	<div class="modal-content">
			...
			<div class="modal-body">
				<form  id="registro" name="registro">	
					...
					<div class="row"> 
						<div class="col">
							<div class="input-group mb-3">
								<div class="input-group-prepend">
									...
									<input name="nombre" class="form-control" type="text" placeholder="" lang="1" >	
							</div>
						</div>
						...
						<div class="col">
							<div class="input-group mb-3">
								...
								<select name="codigo_proveedor" class="form-control"  id="codigo_proveedor"></select>
							</div>
						</div>
						...
						<div class="col">
							<div class="input-group mb-3">
								...
								<select name="codigo_concepto" class="form-control"  id="codigo_concepto" lang="1"></select>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col">
							<div class="input-group mb-3">
								...
								<input name="valor" type="number"  class="form-control" placeholder="" lang="1">	
							</div>
						</div>
						...
						<div class="col">
							<div class="input-group mb-3">
								<div class="input-group-prepend">
									<span class="input-group-text" >Fecha Proximo Cobro</span>
								</div>
								<input name="fecha_proximo" type="date"  class="form-control" placeholder="" lang="1">	
							</div>
						</div>
						...
						<div class="col">
							<div class="input-group mb-3">
								<div class="input-group-prepend">
									<span class="input-group-text" >Frencuencia días</span>
								</div>
								<input name="frecuencia_dia" type="text"  class="form-control" placeholder="" lang="1">	
							</div>
						</div>
					</div>
					...
					<input name="codigo_usuario" type="hidden" value="<?Php echo $_SESSION['codigo_usuario']; ?>"  class="form-control" placeholder="" lang="1">	
...
<script type="text/javascript">
	...
	var	form=[
		{	id:0,
			title: 'Servicios - Pagos Recurrentes',
	...
	function load_modal(n,s,r){
		...
		case 1:
			...
			rellenar_select("tbl_proveedores","codigo_proveedor","razon_social"," 1 order by razon_social","codigo_proveedor");
