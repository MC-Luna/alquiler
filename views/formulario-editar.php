  ...
  <div class="modal-dialog" role="document">
	...
	<div id="tabs" class="tabs"> <!--tabs-->
			...
			<nav>
				...
				<ul>
					...
					<li><a href="#section-5"><span>Soportes</span></a></li>
	...
	<div class="content">		
		...
		<section id="section-1"> <!-- EMPIEZA EN SECTION DE DATOS -->
			...
			<form class="reg_usuarios" name="registro" id="registro_edit" enctype="multipart/form-data">	
				...
				<div class="row">
					...
					<div class="col input-group mb-3">
						...
						<select class="form-control" name="vivienda_tipo" id="vivienda_tipo_select">
							...
							<option value="familiar" id="arriendo">Familiar</option>
...
-->
		...
		<form class="reg_usuarios" name="registro_save" id="form_save_seguridad">	
...
-->
		...
		<h1 style="text-align: center;">CONTRATO</h1>
			...
			<form id="form_contrato_clientes">
					...
					<div class="row">  
						...
						<div class="col-sm-4">
						 ...
						 <div class="input-group mb-3">
						  ...
						  <select class="form-control" name="uso_moto" id="uso_moto_select" disabled>
				...
				<div class="col-4">
					...
					<div class="input-group mb-3">
						...
						<input class="form-control" name="fecha_proximo_cobro" id="fecha_proximo_cobro" type="date" value="0000-00-00" id="example-datetime-local-input" disabled>
				...
				<div class="col-4">
					...
					<div class="input-group mb-3">
						...
						<input type="number" name="valor_pagar" id="valor_pagar" class="form-control" placeholder="" aria-label="valar" aria-describedby="basic-addon1" disabled>
				...
				<div class="col-4">
					...
					<div class="input-group mb-3">
						...
						<input type="text" name="frecuencia_cobro" id="frecuencia_cobro" class="form-control" placeholder="" aria-label="valar" aria-describedby="basic-addon1" disabled>
		...
		<section id="section-5"> <!-- ABRE LA SECTION DE SOPORTES -->


<h1 style="text-align: center;">SOPORTES</h1>

	<div class="container"> <!-- ABRO CONTAINER-->

	<div id="div_listado_soportes"></div>

</div>	


</section> <!-- CIERRA LA SECTION DE SOPORTES -->
